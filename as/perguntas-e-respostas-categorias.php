...
<div class="alinha14"><a href="perguntas-e-respostas">PERGUNTAS E RESPOSTAS</a> >> CATEGORIAS</div></div></div>
...
<form action='perguntas-e-respostas-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
<a href='perguntas-e-respostas-categorias?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a>
</div>
</div></div></div>
...
VALUES (NULL , '$categoria',  '$url'  , 'perguntas-e-respostas'   , '$diaatual/$mesatual/$anoatual'   )"; 
