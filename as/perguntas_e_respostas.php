...
<?php
$sql = "SELECT * FROM perguntas_e_respostas ORDER BY id DESC";
...
<div class=\"painel-banner-listagem-icon\"><a href=\"perguntas-e-respostas-editar?id=$id\"><img src=\"img/editar2.png\"/></a></div>
</div></div>
