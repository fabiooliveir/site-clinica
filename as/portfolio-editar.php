...
<div class="alinha14"><a href="portfolio">PORTFÓLIO</a> >> EDITAR</div></div></div>
...
<div class="painel-banner-botoes1"><a href="portfolio-cadastrar.php"><img src="img/novo.jpg" width="100%"/></a></div>
</div></div></div>

<div id="painel-cliente">
<div class="alinha15">EDITAR PORTFÓLIO SELECIONADO</div>
...
<form action='portfolio-editar?acao=alterar&id=$id' method='post'>
...
$caminho = "<script language='javascript'>function alerta(){alert('Dados Alterados com Sucesso!'); }alerta();document.location='portfolio';</script>";
