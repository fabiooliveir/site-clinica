...
<div class="alinha14"><a href="tratamentos">TRATAMENTOS</a> >> CATEGORIAS</div></div></div>
...
<form action='tratamentos-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
<a href='equipe-categorias?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a>
</div>
</div></div></div>
...
VALUES (NULL , '$categoria',  '$url'  , 'tratamentos'   , '$diaatual/$mesatual/$anoatual'   )"; 
