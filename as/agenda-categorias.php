...
<div class="alinha14"><a href="agenda">AGENDA</a> >> CATEGORIAS</div></div></div>
...
<form action='agenda-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
VALUES (NULL , '$categoria',  '$url'  , 'agenda'   , '$diaatual/$mesatual/$anoatual'   )"; 
