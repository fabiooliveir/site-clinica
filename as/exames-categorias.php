...
<div class="alinha14"><a href="exames">EXAMES</a> >> CATEGORIAS </div></div></div>
...
<form action='exames-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
VALUES (NULL , '$categoria',  '$url'  , 'exames'   , '$diaatual/$mesatual/$anoatual'   )"; 
