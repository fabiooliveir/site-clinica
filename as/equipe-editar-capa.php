...
if ($imagem ==''){echo"
<form action='equipe-editar-capa.php?acao=alterarx&id=$id' method='post'  enctype='multipart/form-data'>
<div style=\"float: left;\">
<img src='avatar.jpg'  width='30%' border='0' ></div>

<div id=\"formulario\">	
<label for=\"nome\">Imagem:</label>
<span class=\"tooltiptext\">Tamanho da Imagem 500px X 500px</span>
...
<form action='equipe-editar-capa.php?acao=alterar1&id=$id' method='post'  enctype='multipart/form-data'>

<img src='../img2/equipe/$imagem' width='50%' border='0'> <br><br>
...
$msg = false;
  if(isset($_FILES['imagem'])){
    ...
    $diretorio = "../img2/equipe/"; //define o diretorio para onde enviaremos o arquivo
    move_uploaded_file($_FILES['imagem']['tmp_name'], $diretorio.$novo_nome); //efetua o upload
	chmod ("../img2/equipe/$novo_nome", 0777);
  
$sql="UPDATE  `equipe` SET  `imagem` =  '$novo_nome' WHERE  `id` ='$id'";
...
$caminho = "<script language='javascript'>
      ...
      $id = $_GET['id'];
      $sql="UPDATE  `equipe` SET `imagem` =  ''  WHERE  `id` ='$id';";
