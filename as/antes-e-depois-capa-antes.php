...
if ($imagem_antes ==''){echo"
<form action='antes-e-depois-capa-antes?acao=alterarx&id=$id' method='post'  enctype='multipart/form-data'>
...
<form action='antes-e-depois-capa-antes?acao=alterar1&id=$id' method='post'  enctype='multipart/form-data'>

<img src='../img2/antes_e_depois/$imagem_antes' width='50%' border='0'> <br><br>
...
$sql="UPDATE  `antes_e_depois` SET  `imagem_antes` =  '$novo_nome' WHERE  `id` ='$id'";
...
$caminho = "<script language='javascript'>
      ...
      $id = $_GET['id'];
      $sql="UPDATE  `antes_e_depois` SET `imagem_antes` =  ''  WHERE  `id` ='$id';";
