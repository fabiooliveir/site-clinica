...
<div class="alinha14"><a href="banner">BANNER</a> >> CATEGORIAS</div></div></div>
...
<form action='banner-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
<a href='banner-categorias?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a>
</div>
</div></div></div>
...
VALUES (NULL , '$categoria',  '$url'  , 'banner'   , '$diaatual/$mesatual/$anoatual'   )"; 
