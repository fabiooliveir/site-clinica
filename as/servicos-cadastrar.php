...
<div class="alinha14"><a href="banner">SERVIÇOS</a> >> CADASTRAR</div></div></div>
...
<a href="servicos-cadastrar"><div class="painel-banner-botoes1"><img src="img/novo.jpg" width="100%"/></div></a>
</div></div></div>
...
chmod ("../img2/servicos/$nome_imagem", 0777);
		 
$sql = "INSERT INTO `servicos` (`id`, `titulo`, `titulo_slug`, `data_cadastro`, `imagem`, `desc`, `posicao`) 
VALUES (NULL, '$titulo', '$titulo_slug', '$data_cadastro', '$nome_imagem', '$desc', '0');
";
...
<form  action='servicos-cadastrar?acao=cadastrar' method='post' enctype='multipart/form-data'>
