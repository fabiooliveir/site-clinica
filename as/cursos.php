...
<div id="grid12">
<div class="painel-cliente-icone"><img src="img/icons/cursos.png" width="100%"/></div>
...
echo"<div class=\"alinha14\">CURSOS ($linhas)</div>";?> 
...
<a href="noticias-categorias"><div class="painel-banner-botoes1" style="display: none"><img src="img/categorias.jpg" width="100%"/></div></a>

<a href="cursos-cadastrar"><div class="painel-banner-botoes1"><a href="cursos-cadastrar"><img src="img/novo.jpg" width="100%"/></a></div></a>
</div></div></div>
...
$sql2 = "SELECT * FROM categorias WHERE tipo ='cursos' and categoria_slug = '$categoria'";
...
<div class=\"painel-banner-listagem-icon\"><a href='cursos?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a></div>

<div class=\"painel-banner-listagem-icon\"><a href=\"cursos-editar?id=$id\"><img src=\"img/editar2.png\"/></a></div>
</div></div>

<div id=\"showbanner\"><img src=\"../img2/cursos/$imagem\" width=\"100%\"></div>
</div>
