...
<div class="alinha14"><a href="equipe">EQUIPE</a> >> CATEGORIAS</div></div></div>
...
<form action='equipe-categorias?acao=cadastrar' method='POST' enctype="multipart/form-data">
...
VALUES (NULL , '$categoria',  '$url'  , 'equipe'   , '$diaatual/$mesatual/$anoatual'   )"; 
