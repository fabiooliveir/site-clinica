...
<a href="videos-cadastrar"><div class="painel-banner-botoes1"><a href="vagas"><img src="img/novo.jpg" width="100%"/></a></div></a>
</div></div></div>
...
<div class=\"painel-banner-listagem-icon\"><a href='vagas_editar?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a></div>
