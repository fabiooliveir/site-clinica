...
echo"<div class=\"alinha14\">REORDENAR SEQUÊNCIA NÓTÍCIAS ($linhas)</div>";?> 
	</div></div>
<div id="grid12F"><div id="painel-banner-botoes-center">

<a href="noticias-sequencia"><div class="painel-banner-botoes2"><img src="img/reorder.png" width="100%"/></div></a>
...
<div class=\"painel-banner-text\" ><img src=\"../img2/noticias/$imagem\" width=\"40\"></div>
<div class=\"painel-banner-text\">$titulo</div>";

$sql2 = "SELECT * FROM categorias WHERE tipo ='Notícias'";
...
echo"</li>";
	...
	<div style="clear: both; margin-top: 20px;">
       <input type="button"  style="cursor:pointer" class="cadastrar" value="ALTERAR" id='submit'/>   </div>
