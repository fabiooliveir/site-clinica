...
echo"<div class=\"alinha14\">DOWNLOADS ($linhas)</div>";?> 
...
<a href="downloads-cadastrar"><div class="painel-banner-botoes1"><a href="downloads-cadastrar"><img src="img/novo.jpg" width="100%"/></a></div></a>
</div></div></div>
...
<div class=\"painel-banner-text\">$nome_arquivo</div>


<div id=\"grid12F\"><div id=\"painel-banner-listagemIcon-center\">

<div class=\"painel-banner-listagem-icon\"><a href='downloads?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a></div>

<div class=\"painel-banner-listagem-icon\"><a href=\"downloads-editar?id=$id\"><img src=\"img/editar2.png\"/></a></div>
</div></div>

<div id=\"showbanner\" style=\"text-align: left;\">Link: $link_arquivo</div>
</div>
