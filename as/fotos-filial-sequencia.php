...
jq(document).ready(function(){
  ...
  jq('#submit').click(function(){
    ...
    // AJAX request
    $.ajax({
      url: 're/reordenar-fotos-filiais.php',
      type: 'post',
...
<?php
$id = $_GET['id'];
$sql = "SELECT * FROM fotos_filiais WHERE postid = '$id'";
$comando = mysqli_query($conn, $sql);
$linhas = mysqli_num_rows($comando); 
echo"<div class=\"alinha14\">REORDENAR FOTOS DA FILIAL ($linhas)</div>";?> 
	

</div></div>
<div id="grid12F"><div id="painel-banner-botoes-center">	
<a href="fotos-filial-sequencia"><div class="painel-banner-botoes2"><img src="img/reorder.png" width="100%"/></div></a>
</div></div></div>
...
<?php
$id = $_GET['id'];
$sql = "SELECT * FROM fotos_filiais WHERE postid = '$id' ORDER BY posicao ASC";
$comando = mysqli_query($conn, $sql);
...
<div class=\"painel-banner-text\" ><img src=\"../img2/fotos_filiais/$imagem\" width=\"60\"></div>
