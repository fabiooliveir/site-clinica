...
<div class="alinha14"><a href="cursos">CURSOS</a> >> CADASTRAR</div></div></div>
...
<a href="cursos-cadastrar"><div class="painel-banner-botoes1"><img src="img/novo.jpg" width="100%"/></div></a>
</div></div></div>
...
chmod ("../img2/cursos/$nome_imagem", 0777);
		 
$sql = "INSERT INTO `cursos` (`id`, `nome`, `nome_slug`, `desc`, `valor`, `data`, `imagem`, `local` , `link`) 
 VALUES (NULL, '$nome', '$nome_slug',  '$desc', '$valor', '$data', '$nome_imagem', '$local' , '$link')";
...
<form  action='cursos-cadastrar?acao=cadastrar' method='post' enctype='multipart/form-data'>
...
<input type="text" name="data" class="form3" required/>
</div>
...
<input type="text" name="link" class="form3" required/>
</div>
