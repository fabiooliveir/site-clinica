...
echo"<div class=\"alinha14\">RECEITAS ($linhas)</div>";?> 
...
<a href="receitas-cadastrar"><div class="painel-banner-botoes1"><a href="receitas-cadastrar"><img src="img/novo.jpg" width="100%"/></a></div></a>
...
$sql2 = "SELECT * FROM categorias WHERE tipo ='receitas' and categoria_slug = '$categoria'";
...
<div class=\"painel-banner-listagem-icon\"><a href='receitas?acao=remove&id=$id' onclick=\"return confirm('Certeza que deseja excluir?');\"><img src=\"img/excluir2.png\"/></a></div>

<div class=\"painel-banner-listagem-icon\"><a href=\"receitas-editar?id=$id\"><img src=\"img/editar2.png\"/></a></div>
</div></div>

<div id=\"showbanner\"><img src=\"../img2/receitas/$imagem\" width=\"100%\"></div>
</div>
