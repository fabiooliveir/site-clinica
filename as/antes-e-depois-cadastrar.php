...
<div class="alinha14"><a href="banner">ANTES E DEPOIS</a> >> CADASTRAR</div></div></div>
...
<a href="antes-e-depois-cadastrar"><div class="painel-banner-botoes1"><img src="img/novo.jpg" width="100%"/></div></a>
</div></div></div>
...
chmod ("../img2/antes_e_depois/$nome_imagem", 0777);
		 
$sql = "INSERT INTO `antes_e_depois` (`id`, `data_cadastro`, `titulo`, `titulo_slug`, `desc`, `imagem_antes`, `imagem_depois`, `destaque`) 
VALUES (NULL, '$data_cadastro', '$titulo', '$titulo_slug', '$desc', '$nome_imagem', '', '$destaque');
";
...
if ($conn->query($sql) === TRUE) {  
  ...
  echo"<BR><script language='javascript'>
      function alerta(){
      alert('Antes e Depois cadastrado com sucesso! ');
      }
      alerta();
...
<form  action='antes-e-depois-cadastrar?acao=cadastrar' method='post' enctype='multipart/form-data'>
...
<span class="tooltiptext">Tamanho da Imagem 1200x800px</span>
</div>
...
<div class="tooltip">
<div class="iterativo iiterativo">i</div>
<span class="tooltiptext">Exibição página inicial do site</span>
</div></label>
