...
<div id="grid12">		
<div class="ferramentas-painel-logo"><img src="img/icons/contratante.png" width="100%"/></div>
<div class="alinha6">CONTRATANTE CÓDIGOS</div>
</div>
		
<div id="ferramentas-painel-padding">
	
<div id="codigos_php"><strong>Nome do Banco de Dados:</strong> contratante</div>	
		
<div id="codigos_php"><strong>Pasta de Imagem:</strong> img2/capa_galeria</div>	

<div id="codigos_php">
<strong>Nome:</strong> $nome<BR><BR>
<strong>Arquivo:</strong> $arquivo<BR><BR>
